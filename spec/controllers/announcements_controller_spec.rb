  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved announcement as @announcement" do
        ...
        post :create, {:announcement => { "description" => "invalid value" }}, valid_session
        assigns(:announcement).should be_a_new(Announcement)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested announcement" do
        ...
        Announcement.any_instance.should_receive(:update).with({ "description" => "MyString" })
        put :update, {:id => announcement.to_param, :announcement => { "description" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the announcement as @announcement" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Announcement.any_instance.stub(:save).and_return(false)
        put :update, {:id => announcement.to_param, :announcement => { "description" => "invalid value" }}, valid_session
        assigns(:announcement).should eq(announcement)
      end
